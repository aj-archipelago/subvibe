import { parse, resync } from '../index';
...
describe('resync function', () => {
    ...
    test('should filter invalid runtime input', () => {
        const shifted = resync([
            testCues[0],
            { index: 2, startTime: 'bad', endTime: 8000, text: 'Drop me' },
            { index: 3, startTime: 8500, endTime: 12000, text: null }
        ] as any, { offset: 1000 });
        ...
        expect(resync(null as any, { offset: 1000 })).toEqual([]);
    });
});
